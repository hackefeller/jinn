 ...
 * Supermaven adapter
 *
 * Formats commands and skills for Supermaven.
 * Supermaven uses:
 * - Skills: .supermaven/skills/<name>/SKILL.md
 * - Commands: .supermaven/commands/<name>.md
...
export const supermavenAdapter: ToolCommandAdapter = {
  toolId: 'supermaven',
  toolName: 'Supermaven',
  ...
  getSkillPath(skillName: string): string {
    return path.join('.supermaven', 'skills', skillName, 'SKILL.md');
  },
