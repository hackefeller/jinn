 ...
 * Augment adapter
 *
 * Formats commands and skills for Augment.
 * Augment uses:
...
export const augmentAdapter: ToolCommandAdapter = {
  toolId: 'augment',
  toolName: 'Augment',
  skillsDir: '.augment',

  getCommandPath(commandId: string): string {
    return path.join('.augment', 'commands', `ghostwire-${commandId}.md`);
  },

  getSkillPath(skillName: string): string {
    return path.join('.augment', 'skills', skillName, 'SKILL.md');
  },
