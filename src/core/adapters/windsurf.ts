 ...
 * Windsurf adapter
 *
 * Formats commands and skills for Windsurf.
 * Windsurf uses:
 * - Skills: .windsurf/skills/<name>/SKILL.md
 * - Commands: .windsurf/commands/<name>.md
...
export const windsurfAdapter: ToolCommandAdapter = {
  ...
  getCommandPath(commandId: string): string {
    return path.join('.windsurf', 'commands', `ghostwire-${commandId}.md`);
  },

  getSkillPath(skillName: string): string {
    return path.join('.windsurf', 'skills', skillName, 'SKILL.md');
  },
