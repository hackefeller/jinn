 ...
 * GPT4All adapter
 *
 * Formats commands and skills for GPT4All.
 * GPT4All uses:
 * - Skills: .gpt4all/skills/<name>/SKILL.md
 * - Commands: .gpt4all/commands/<name>.md
...
export const gpt4allAdapter: ToolCommandAdapter = {
  toolId: 'gpt4all',
  toolName: 'GPT4All',
  skillsDir: '.gpt4all',

  getCommandPath(commandId: string): string {
    return path.join('.gpt4all', 'commands', `ghostwire-${commandId}.md`);
  },

  getSkillPath(skillName: string): string {
    return path.join('.gpt4all', 'skills', skillName, 'SKILL.md');
  },
