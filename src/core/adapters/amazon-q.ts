 ...
 *
 * Formats commands and skills for Amazon Q Developer.
 * Amazon Q uses:
 * - Skills: .amazonq/skills/<name>/SKILL.md
 * - Commands: .amazonq/commands/<name>.md
...
export const amazonQAdapter: ToolCommandAdapter = {
  ...
  getCommandPath(commandId: string): string {
    return path.join('.amazonq', 'commands', `ghostwire-${commandId}.md`);
  },

  getSkillPath(skillName: string): string {
    return path.join('.amazonq', 'skills', skillName, 'SKILL.md');
  },
