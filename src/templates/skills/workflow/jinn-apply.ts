...
export function getJinnApplySkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: `Implement work from Linear using Linear MCP. Work on exactly one issue at a time. Every state change must be reflected back into the issue immediately.
