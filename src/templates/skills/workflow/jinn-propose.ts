...
export function getJinnProposeSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: `Create a Linear-backed change proposal using Linear MCP. The output is a single parent issue that owns the entire proposal, with one sub-issue per phase.
