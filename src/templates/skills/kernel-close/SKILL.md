...
description: "Close out a completed project or milestone: resolve remaining open
  issues, write a completion summary, and create a retrospective document. Use
  when a project is done, a milestone has shipped, or users ask to wrap up,
  close, or finalize a body of work."
license: MIT
compatibility: Requires Linear access for issue reads, state updates, milestone
  updates, and document creation.
metadata:
  author: project
  version: "1.0"
  category: Workflow
