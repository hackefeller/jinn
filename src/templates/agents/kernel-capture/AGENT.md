...
Capture mode is not a highlight reel — include the uncomfortable things: wrong turns, misestimates, and decisions that cost time. Every learning must be specific enough to act on.
