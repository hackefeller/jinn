...
export const NAME = "ghostwire:spec:create";
export const DESCRIPTION = "Create feature specification from natural language description";
...
export const ARGUMENT_HINT = '"feature description in natural language"';
