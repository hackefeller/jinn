...
// workflows commands
import { COMMAND as WORKFLOWS_PLAN_COMMAND, NAME as WORKFLOWS_PLAN_NAME } from "./commands/workflows.plan";
import { COMMAND as WORKFLOWS_EXECUTE_COMMAND, NAME as WORKFLOWS_EXECUTE_NAME } from "./commands/workflows.execute";
import { COMMAND as WORKFLOWS_STOP_COMMAND, NAME as WORKFLOWS_STOP_NAME } from "./commands/workflows.stop";
import { COMMAND as WORKFLOWS_CREATE_COMMAND, NAME as WORKFLOWS_CREATE_NAME } from "./commands/workflows.create";
import { COMMAND as WORKFLOWS_STATUS_COMMAND, NAME as WORKFLOWS_STATUS_NAME } from "./commands/workflows.status";
import { COMMAND as WORKFLOWS_COMPLETE_COMMAND, NAME as WORKFLOWS_COMPLETE_NAME } from "./commands/workflows.complete";
import { COMMAND as WORKFLOWS_BRAINSTORM_COMMAND, NAME as WORKFLOWS_BRAINSTORM_NAME } from "./commands/workflows.brainstorm";
import { COMMAND as WORKFLOWS_LEARNINGS_COMMAND, NAME as WORKFLOWS_LEARNINGS_NAME } from "./commands/workflows.learnings";
import { COMMAND as WORKFLOWS_REVIEW_COMMAND, NAME as WORKFLOWS_REVIEW_NAME } from "./commands/workflows.review";
import { COMMAND as WORKFLOWS_WORK_COMMAND, NAME as WORKFLOWS_WORK_NAME } from "./commands/workflows.work";

// code commands
import { COMMAND as CODE_REFACTOR_COMMAND, NAME as CODE_REFACTOR_NAME } from "./commands/code.refactor";
import { COMMAND as CODE_REVIEW_COMMAND, NAME as CODE_REVIEW_NAME } from "./commands/code.review";
import { COMMAND as CODE_OPTIMIZE_COMMAND, NAME as CODE_OPTIMIZE_NAME } from "./commands/code.optimize";
import { COMMAND as CODE_FORMAT_COMMAND, NAME as CODE_FORMAT_NAME } from "./commands/code.format";

// git commands
import { COMMAND as GIT_SMART_COMMIT_COMMAND, NAME as GIT_SMART_COMMIT_NAME } from "./commands/git.smart-commit";
...
import { COMMAND as UTIL_RESTORE_COMMAND, NAME as UTIL_RESTORE_NAME } from "./commands/util.restore";
import { COMMAND as UTIL_DOCTOR_COMMAND, NAME as UTIL_DOCTOR_NAME } from "./commands/util.doctor";

// docs commands
import { COMMAND as DOCS_DEPLOY_DOCS_COMMAND, NAME as DOCS_DEPLOY_DOCS_NAME } from "./commands/docs.deploy-docs";
import { COMMAND as DOCS_RELEASE_DOCS_COMMAND, NAME as DOCS_RELEASE_DOCS_NAME } from "./commands/docs.release-docs";
import { COMMAND as DOCS_FEATURE_VIDEO_COMMAND, NAME as DOCS_FEATURE_VIDEO_NAME } from "./commands/docs.feature-video";
import { COMMAND as DOCS_TEST_BROWSER_COMMAND, NAME as DOCS_TEST_BROWSER_NAME } from "./commands/docs.test-browser";
...
const COMMAND_MODULES: Record<string, { name: CommandName; command: Omit<CommandDefinition, "name"> }> = {
  ...
  [WORKFLOWS_BRAINSTORM_NAME]: { name: WORKFLOWS_BRAINSTORM_NAME, command: WORKFLOWS_BRAINSTORM_COMMAND },
  [WORKFLOWS_LEARNINGS_NAME]: { name: WORKFLOWS_LEARNINGS_NAME, command: WORKFLOWS_LEARNINGS_COMMAND },
...
> = Object.values(COMMAND_MODULES).reduce((acc, mod) => {
