...
export const AGENTS_MANIFEST: ReadonlyArray<LoadedAgent> = [
  {
    ...
    name: "orchestrator",
    purpose:
      "Orchestrates work via delegate_task() to complete ALL tasks in a todo list until fully done. Coordinates agents, verifies, and enforces QA gates.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    purpose:
      'Contextual codebase search agent. Answers "Where is X?", "Which file has Y?", "Find the code that does Z" by running broad searches and returning actionable results.',
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
    ...
    triggers: [
      {
        ...
        trigger:
          "Unfamiliar packages or libraries, struggles at weird behaviour (to find existing implementation of opensource)",
      },
    ],
    useWhen: [
  ...
  },
  {
    ...
    purpose:
      "Security audits, vulnerability assessments, and security reviews of code. Checks for common security vulnerabilities, validates input handling, reviews authentication and authorization implementations, scans for hardcoded secrets, and ensures OWASP compliance.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    purpose:
      "Create comprehensive pre/post-deploy checklists for changes that touch production data, migrations, or behavior that could silently discard or duplicate records. Essential for risky data changes requiring Go or No-Go decisions.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    name: "Dark Runner",
    purpose:
      "Focused task executor. Executes tasks directly with strict todo discipline and verification. Never delegates implementation to other agents.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    purpose:
      "Brutally honest Rails code review from DHH's perspective. Identifies anti-patterns, JavaScript framework contamination, and violations of Rails conventions.",
    models: {
      primary: "inherit",
    },
    temperature: 0.2,
  ...
  },
  {
    ...
    purpose:
      "Write Ruby gems following Andrew Kane's patterns with simple APIs, clear docs, and sensible defaults.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    purpose:
      "Final review pass to ensure code changes are as simple and minimal as possible. Identifies opportunities for simplification and enforces YAGNI principles.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    name: "Style Editor",
    purpose:
      "Review and edit text content to conform to a style guide with systematic line-by-line review.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    name: "planner",
    purpose:
      "Strategic planning consultant that interviews users, gathers context, and produces comprehensive work plans in markdown. Never implements code directly.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    name: "Void Runner",
    purpose:
      "Primary operator agent that parses intent, delegates tasks, and executes work directly when appropriate. Coordinates specialized agents and tools for implementation.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    name: "Glitch Auditor",
    purpose:
      "Expert reviewer for evaluating work plans against rigorous clarity, verifiability, and completeness standards. Ensures plans are executable and references are valid.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
  ...
  },
  {
    ...
    purpose:
      "Pre-planning consultant that analyzes user intent, surfaces hidden requirements, and prepares directives for the planner agent to prevent AI failures.",
    models: {
      primary: "inherit",
    },
    temperature: 0.1,
