...
- Use `mcp_linear_save_issue` to create the issue with:
  ...
  - A clear description: **what** is wrong or needed, **acceptance criteria**, and any reproduction steps for bugs.
- Status: `Todo`.
...
- Always use Linear MCP tools — never create offline issue lists or sticky notes.
