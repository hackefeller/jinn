...
- [ ] T006 [P] Review plugin agent loading in `src/execution/claude-code-plugin-loader/loader.ts`
...
- [x] T073 Update `src/execution/claude-code-plugin-loader/loader.ts` - ensure loadPluginAgents() doesn't re-import deduplicated agents
