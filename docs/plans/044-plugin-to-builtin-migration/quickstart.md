...
# Output: src/execution/builtin-commands/templates/plan-review.ts
...
mv src/plugin/skills/file-todos src/execution/builtin-skills/
...
# Skills now load from src/execution/builtin-skills/
```
...
rm src/execution/builtin-commands/templates/plan-review.ts
