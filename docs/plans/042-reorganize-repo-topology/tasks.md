...
- [x] T018 [P] [US1] Move features/ → execution/ using `git mv src/features src/execution/features` in /Users/charlesponti/Developer/agents/
...
- [x] T024 [US1] Update imports in `src/index.ts` from `./features/` to `./execution/` and `./tools/` to `./execution/tools/` in /Users/charlesponti/Developer/agents/src/index.ts
...
- [x] T026 [US1] Update all feature paths in `features.yml` from `src/features/` to `src/execution/` in /Users/charlesponti/Developer/agents/features.yml
...
- [x] T030 [US1] Run sample tests: `bun test src/execution/*.test.ts` and verify pass in /Users/charlesponti/Developer/agents/
