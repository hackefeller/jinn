...
```
Current Path                    → New Path
src/features/                   → src/execution/
src/features/*/                 → src/execution/*/
src/features/**/*.ts            → src/execution/**/*.ts
```
...
- `src/features/builtin-skills/` → `src/execution/builtin-skills/`
- `src/features/builtin-commands/` → `src/execution/builtin-commands/`
- `src/features/background-agent/` → `src/execution/background-agent/`
...
```
features.yml: Update all paths from "src/features/" → "src/execution/"
...
src/index.ts:
  - Update: import * as features from './features/index.js'
          → import * as features from './execution/index.js'
